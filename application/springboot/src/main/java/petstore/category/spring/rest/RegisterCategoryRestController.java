 ...
 */
@RestController
public class RegisterCategoryRestController {

    @Autowired
    CategoryRegisterController adapter;
    ...
    public Mono<ResponseEntity<CategoryResponse>> post(
        @Valid
        @RequestBody(required = true)
        CategoryRequest req) {

        return 
            Mono.fromFuture(adapter.register(() -> req))
                .onErrorMap(e -> 
